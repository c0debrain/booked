...
$conf['settings']['app.title'] = 'Booked';
...
$conf['settings']['script.url'] = 'https://booked.codebrain.io/Web';
...
$conf['settings']['database']['user'] = 'admin';
...
$conf['settings']['phpmailer']['smtp.host'] = 'codebrain.co';
