...
$conf['settings']['database']['user'] = 'admin';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'admin101';
...
$conf['settings']['phpmailer']['smtp.host'] = 'codebrain.co';               // 'smtp.company.com'
...
$conf['settings']['phpmailer']['smtp.username'] = 'mailbot@codebrain.io';
$conf['settings']['phpmailer']['smtp.password'] = 'testtest101';
 ...
 */
$conf['settings']['install.password'] = '39eb3b9c368db1ab7673aedd169d49656ebdc6325a25430d96';
/**
 * Pages
 */
