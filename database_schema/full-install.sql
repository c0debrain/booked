...
GRANT ALL on booked.* to 'booked_user'@'127.0.0.1' identified by 'password';SET foreign_key_checks = 0;
...
ALTER TABLE `schedules` ADD COLUMN `default_layout` TINYINT NOT NULL DEFAULT 0;insert into user_statuses values (1, 'Active'), (2, 'Awaiting'), (3, 'Inactive');
