<?php
/* Smarty version 3.1.30, created on 2019-04-07 03:32:24
  from "/var/www/booked/lang/en_us/help-admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ca96f4875a767_71869704',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fb4ebe17fd2f6d272d77f61764bdb7319cc56bda' => 
    array (
      0 => '/var/www/booked/lang/en_us/help-admin.tpl',
      1 => 1549400544,
      2 => 'file',
    ),
  ),
...
function content_5ca96f4875a767_71869704 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div id="page-help-admin">
 ...
 Administration</h1>
            ...
            <div id="help-getting-started">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 lets you manage resources of any type. Conference rooms, tennis courts, rental cars,
                    these
                    are
            ...
            <div id="help-tablet-view">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 provides a tablet-friendly view of a resource's current availability. To launch this
                    view,
                    open <?php echo $_smarty_tpl->tpl_vars['ScriptUrl']->value;?>
/resource-display.php then choose the resource to display. From here users can
                    view the
            ...
            <div id="help-monitor-view">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 provides a monitor-friendly view of a schedule's current availability. To launch this
                    view,
                    open <?php echo $_smarty_tpl->tpl_vars['ScriptUrl']->value;?>
/monitor-display.php then configure the reservations to display. A good use of this
            ...
            <div id="help-slack-integration">
                ...
                <p>When creating your App, choose <em>Slash Commands</em> in the <em>Add features and functionality</em>
                    ...
                    a name you will remember - we recommend <em>/book</em>. Set the <em>Request URL</em> to <?php echo $_smarty_tpl->tpl_vars['ScriptUrl']->value;?>
            ...
            <div id="help-reminders">
                ...
                <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the
                    ...
                    Jobs/sendreminders.php. The full path to sendreminders.php on this server is <span
                            class="note"><?php echo $_smarty_tpl->tpl_vars['RemindersPath']->value;?>
</span>
                </p>

                <p>An example cron configuration might look like: <span
                            class="note">* * * * * php -f <?php echo $_smarty_tpl->tpl_vars['RemindersPath']->value;?>
</span>
                </p>
                ...
                <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a
                    ...
                    the
                    full path to <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
\Jobs\sendreminders.php. For example, c:\PHP\php.exe -f
            ...
            <div id="help-autorelease">
                ...
                <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the
                    ...
                    Jobs/autorelease.php. The full path to autorelease.php on this server is <span
                            class="note"><?php echo $_smarty_tpl->tpl_vars['AutoReleasePath']->value;?>
</span>
                </p>

                <p>An example cron configuration might look like: <span
                            class="note">* * * * * php -f <?php echo $_smarty_tpl->tpl_vars['AutoReleasePath']->value;?>
</span>
                </p>
            ...
            <div id="help-waitlist">
                ...
                <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the
                    ...
                    Jobs/sendwaitlist.php. The full path to sendwaitlist.php on this server is <span
                            class="note"><?php echo $_smarty_tpl->tpl_vars['WaitListPath']->value;?>
</span>
                </p>

                <p>An example cron configuration might look like: <span
                            class="note">* * * * * php -f <?php echo $_smarty_tpl->tpl_vars['WaitListPath']->value;?>
</span>
                </p>
            ...
            <div id="help-missed-checkin">
                ...
                <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the
                    ...
                    Jobs/sendmissedcheckin.php. The full path to sendmissedcheckin.php on this server is <span
                            class="note"><?php echo $_smarty_tpl->tpl_vars['MissedCheckinPath']->value;?>
</span>
                </p>

                <p>An example cron configuration might look like: <span
                            class="note">* * * * * php -f <?php echo $_smarty_tpl->tpl_vars['MissedCheckinPath']->value;?>
</span>
                </p>
                ...
                <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a
                    ...
                    the
                    full path to <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
\Jobs\sendmissedcheckin.php. For example, c:\PHP\php.exe -f
 ...
 lang directory</p>
                ...
                <p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this
                    ...
                    of
                    <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
. This should be the Web directory which contains files like schedule.php and
                    calendar.php.
                    If this
 ...
 root directory.</p>
                ...
                <p class="setting"><span>$conf['settings']['css.extension.file']</span>Full or relative URL to an
                    ...
                    blank
                    if you
                    are not extending the style of <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
.</p>
                ...
                <p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>The full or
                    relative
                    filesystem path (relative to the root of your <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 directory) to store reservation
                    attachments.
                    This
                ...
                <p class="setting"><span>$conf['settings']['database']['name']</span>Name of <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 database</p>
                ...
                <p class="setting"><span>$conf['settings']['api']['enabled']</span>If the <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
's RESTful API
                    should
                    be enabled.
                ...
                <p class="setting"><span>$conf['settings']['reservation.labels']['reservation.popup']</span>The
                    ...
                    Possible values are {name} {dates} {duration} {
                    title} {resources} {participants} {accessories}
                    {description}
                    {phone} {email}
                    {attributes} {pending}. Reservation custom attributes can be
                ...
                <p class="setting"><span>$conf['settings']['google.analytics']['tracking.id']</span>Your Google
                    ...
                    Analytics tracking code will be added to every page in <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
.</p>
 ...
 using Google. Default is false.</p>
            ...
            <div id="help-active-directory">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 can authenticate your users against Active Directory. To enable this, first set <span
                ...
                <p class="setting"><span>$conf['settings']['database.auth.when.ldap.user.not.found']</span>If Active
                    Directory
                    auth
                    fails, authenticate against <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
                ...
                <p class="setting"><span>$conf['settings']['sync.groups']</span>Whether or not to sync group membership
                    into <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
.
                    The Active Directory groups must first
                    be created in <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
. Anything that doesn't exist in <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 will be skipped.</p>
            ...
            <div id="help-ldap">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 can authenticate your users against LDAP. To enable this, first set <span
 ...
 database</p>
            ...
            <div id="help-cas">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 can authenticate your users against CAS. To enable this, first set <span
 ...
 as username@yourdomain.com</p>
            ...
            <div id="help-saml">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 relies on <a href="https://simplesamlphp.org/" target="_blank">SimpleSAMLphp</a> to
            ...
            <div id="help-wordpress">
                ...
                <p><?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
 can authenticate your users against a WordPress site running on the same server
                    as <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
.
                    To
                    enable this,
                ...
                <p class="setting"><span>$conf['settings']['wp_includes.directory']</span>The full path to your
                    wp-includes
                    directory or path relative to <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
                ...
                <p class="setting"><span>$conf['settings']['database.auth.when.wp.user.not.found']</span>If WordPress
                    auth
                    fails,
                    authenticate against <?php echo $_smarty_tpl->tpl_vars['AppTitle']->value;?>
